//
//  GroupchatPageViewController.swift
//  NewProject
//
...
protocol updateChatView {
    
    func updateHeader(index:Int)
}


class GroupchatPageViewController: UIPageViewController {
    
    var customDelegate: updateChatView?
    var currentIndex = 1
    ...
    private var firstController  : AllPostViewController? = AllPostViewController.instance()
    private var secondController : GalleryViewController? =  GalleryViewController.instance()
...
extension GroupchatPageViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource{
