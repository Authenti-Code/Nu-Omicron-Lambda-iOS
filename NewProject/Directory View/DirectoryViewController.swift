...
import SDWebImage
class DirectoryViewController: UIViewController,APIsDelegate,UISearchBarDelegate {
...
extension DirectoryViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       if let location = dataSource[indexPath.row]["location"] as? String{
            cell.placeLbl.text = dataSource[indexPath.row]["location"] as! String
       }else{
        cell.placeLbl.text = ""
        }
