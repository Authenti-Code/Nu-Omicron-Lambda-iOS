//
//  HelpfulNumbersViewController.swift
//  NewProject
//
...
class HelpfulNumbersViewController:  UIViewController,APIsDelegate,UISearchBarDelegate {
...
extension HelpfulNumbersViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLbl.text  = "Gate House # " + "\(indexPath.row)"
