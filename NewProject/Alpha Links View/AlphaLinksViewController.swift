//
//  AlphaLinksViewController.swift
//  NewProject
//
...
class AlphaLinksViewController: UIViewController,APIsDelegate,UISearchBarDelegate {
...
extension AlphaLinksViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLbl.text  = linkData[indexPath.row]["name"] as? String ?? ""
